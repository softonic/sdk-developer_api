...
class Configuration
{
     ...
     *
     * @var \Softonic\DeveloperApiSdk\ApiClient
     */
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/1.0.1-11/php";
    ...
    {
        $report  = 'PHP SDK (Softonic\DeveloperApiSdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.0.1-11' . PHP_EOL;
        $report .= '    SDK Package Version: 1.0.1-11' . PHP_EOL;
