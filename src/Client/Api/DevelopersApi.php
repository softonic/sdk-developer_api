...
class DevelopersApi
{
     ...
     * @throws \Softonic\DeveloperApiSdk\ApiException on non-2xx response
     */
    public function findDeveloper($body = null)
    {
        list($response) = $this->findDeveloperWithHttpInfo($body);
        return $response;
    }
     ...
     * @throws \Softonic\DeveloperApiSdk\ApiException on non-2xx response
     */
    public function findDeveloperWithHttpInfo($body = null)
    {
        // parse inputs
        $resourcePath = "/developers";
        $httpBody = '';
     ...
     *
     * @param string $id_developer  (required)
     * @return \Softonic\DeveloperApiSdk\Client\Model\Developer
     * @throws \Softonic\DeveloperApiSdk\ApiException on non-2xx response
     */
