...
class DevelopersApi
{
     ...
     * @throws \Softonic\DeveloperApiSdk\ApiException on non-2xx response
     */
    public function replaceDeveloper($body = null)
    {
        list($response) = $this->replaceDeveloperWithHttpInfo($body);
        return $response;
    }
     ...
     * @throws \Softonic\DeveloperApiSdk\ApiException on non-2xx response
     */
    public function replaceDeveloperWithHttpInfo($body = null)
    {
        // parse inputs
        $resourcePath = "/developers/{id_developer}";
        $httpBody = '';
