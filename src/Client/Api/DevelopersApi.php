...
class DevelopersApi
{
    ...
    public function findDeveloperWithHttpInfo($page = null, $limit = null, $search = null)
    {
        ...
        $request = $this->findDeveloperRequest($page, $limit, $search);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findDeveloperAsync($page = null, $limit = null, $search = null)
    {
        return $this->findDeveloperAsyncWithHttpInfo($page, $limit, $search)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findDeveloperAsyncWithHttpInfo($page = null, $limit = null, $search = null)
    {
        $returnType = '\Softonic\DeveloperApiSdk\Client\Model\Developer[]';
        $request = $this->findDeveloperRequest($page, $limit, $search);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function findDeveloperRequest($page = null, $limit = null, $search = null)
    {
        if ($page !== null && $page < 1) {
