...
class Developer implements ArrayAccess
{
    ...
    public function setIdDeveloper($id_developer)
    {
        ...
        if (!preg_match("/^[0-9a-zA-Z](?!.*[\\-]{2})([0-9a-zA-Z\\-]{0,98}[0-9a-zA-Z])?$/", $id_developer)) {
            throw new \InvalidArgumentException('invalid value for $id_developer when calling Developer., must be conform to the pattern /^[0-9a-zA-Z](?!.*[\\-]{2})([0-9a-zA-Z\\-]{0,98}[0-9a-zA-Z])?$/.');
        }
